...
class Blockchain {
    ...
    _addBlock(block) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            {
                reject(Error('Error when adding block'))
            }
        });
    }
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (currentTime - time < 300)
            {
                ...
                {
                    reject(Error('Verification of the message with wallet address and signature failed'));
                }
            }
            else
            {
                reject(Error('The time elapsed is not less than 5 minutes'));
            }
        });
    }
